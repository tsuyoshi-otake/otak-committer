 ...
 * - Property 14: Simple style respects 600 character limit
 * - Property 15: Normal style respects 1200 character limit
 * - Property 16: Detailed style respects 2400 character limit
 */
...
suite('Prompt Service Property Tests', () => {
    /**
     * **Feature: ui-internationalization, Property 14: Simple style respects 600 character limit**
     * **Validates: Requirements 6.1**
     *
     * For any commit message generated with Simple style, the message length
     * should not exceed 600 characters.
     */
    test(
        'Property 14: Simple style has 600 character limit',
        createTaggedPropertyTest(
            'ui-internationalization',
            14,
            'Simple style respects 600 character limit',
            () => {
                // Verify the constant is correctly set
                assert.strictEqual(
                    MESSAGE_LENGTH_LIMITS[MessageStyle.Simple],
                    600,
                    'Simple style should have 600 character limit',
                );
                ...
                assert.strictEqual(
                    ...
                    600,
                    'getMessageLengthLimit should return 600 for Simple style',
                );

                assert.strictEqual(
                    getMessageLengthLimit('simple'),
                    600,
                    'getMessageLengthLimit should return 600 for "simple" string',
                );
            },
        ),
    );
    ...
    /**
     * **Feature: ui-internationalization, Property 15: Normal style respects 1200 character limit**
     * **Validates: Requirements 6.2**
     *
     * For any commit message generated with Normal style, the message length
     * should not exceed 1200 characters.
     */
    test(
        'Property 15: Normal style has 1200 character limit',
        createTaggedPropertyTest(
            'ui-internationalization',
            15,
            'Normal style respects 1200 character limit',
            () => {
                // Verify the constant is correctly set
                assert.strictEqual(
                    MESSAGE_LENGTH_LIMITS[MessageStyle.Normal],
                    1200,
                    'Normal style should have 1200 character limit',
                );
                ...
                assert.strictEqual(
                    ...
                    1200,
                    'getMessageLengthLimit should return 1200 for Normal style',
                );

                assert.strictEqual(
                    getMessageLengthLimit('normal'),
                    1200,
                    'getMessageLengthLimit should return 1200 for "normal" string',
                );
                ...
                assert.strictEqual(
                    ...
                    1200,
                    'getMessageLengthLimit should default to 1200 for unknown style',
                );
            },
        ),
    );
    ...
    /**
     * **Feature: ui-internationalization, Property 16: Detailed style respects 2400 character limit**
     * **Validates: Requirements 6.3**
     *
     * For any commit message generated with Detailed style, the message length
     * should not exceed 2400 characters.
     */
    test(
        'Property 16: Detailed style has 2400 character limit',
        createTaggedPropertyTest(
            'ui-internationalization',
            16,
            'Detailed style respects 2400 character limit',
            () => {
                // Verify the constant is correctly set
                assert.strictEqual(
                    MESSAGE_LENGTH_LIMITS[MessageStyle.Detailed],
                    2400,
                    'Detailed style should have 2400 character limit',
                );
                ...
                assert.strictEqual(
                    ...
                    2400,
                    'getMessageLengthLimit should return 2400 for Detailed style',
                );

                assert.strictEqual(
                    getMessageLengthLimit('detailed'),
                    2400,
                    'getMessageLengthLimit should return 2400 for "detailed" string',
                );
            },
        ),
    );
